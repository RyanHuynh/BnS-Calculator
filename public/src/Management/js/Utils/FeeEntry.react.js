			...
			<div>
				{ this.props.editable ? 
					<form className="feeEntry" onSubmit={this._onEdit} >
						...
						<img src="/Calculator/img/misc/goldCoin.png" />
						...
						<img src="/Calculator/img/misc/silverCoin.png"/>
						...
						img src="/Calculator/img/misc/copperCoin.png" />
				...
				:	<div className="feeEntry">
						{ this.state.gold > 0 ? <div><label>{this.state.gold}</label><img src="/Calculator/img/misc/goldCoin.png" /></div> : null }
						{ this.state.silver > 0 ? <div><label>{this.state.silver}</label><img src="/Calculator/img/misc/silverCoin.png" /></div> : null }
						{ ( this.state.copper > 0 || this.props.fee == 0 ) ? <div><label>{this.state.copper}</label><img src="/Calculator/img/misc/copperCoin.png" /></div> : null }
					</div> 
				}
			</div>
		)
